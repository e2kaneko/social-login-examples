...
App::uses('GithubController', 'Controller');

/**
 * PostsController Test Case
 *
 */
class GithubControllerTestCase extends ControllerTestCase {
	/**
	 * Fixtures
	 *
	 * @var array
	...
	public function setUp() {
		...
		$this->github = new GithubController();
		$this->github->constructClasses();
	}
